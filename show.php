    ...
    <div class="review-menu-item">
      ...
      <?php else: ?>
        <?php for ($i = 0; $i < $menu->getSpiciness(); $i++): ?>
          <img src="coronil.jpg" class='icon-spiciness'>
        <?php endfor ?>
      <?php endif ?>
    ...
    <div class="review-list-wrapper">
      <div class="review-list">
        <div class="review-list-title">
          <img src="hairfallkit.jpg" class='icon-review'>
          <h4>Reviews</h4>
        </div>
          ...
          <div class="review-list-item">
            <div class="review-user">
              <?php if ($user->getGender() == ''): ?>
                <img src="denatalkit.jpg" class='icon-user'>
              <?php else: ?>
              	<img src="first.jpg" class="icon-user">
              <?php endif ?>
